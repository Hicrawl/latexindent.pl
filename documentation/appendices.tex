...
\end{commandshell}
	 ...
	 activate environment. You don't even have to worry about ``defaultSettings.yaml`` as it
	 included too, you can thus skip \cref{sec:requiredmodules,sec:updating-path}.

	 You can get a conda installation for example from
	 \href{conda-forge}{https://github.com/conda-forge/miniforge} or from
	 \href{anaconda}{https://www.anaconda.com/products/individual}.

	 Thanks to \cite{tdegeus} for their contributions to this work.
